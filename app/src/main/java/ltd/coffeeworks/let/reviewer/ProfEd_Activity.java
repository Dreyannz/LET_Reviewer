...
public class ProfEd_Activity extends AppCompatActivity implements View.OnClickListener
{
	...
	private TextView question, question_profed, labelA, labelB, labelC, labelD, OptionAText, OptionBText, OptionCText, OptionDText;

	private ProfEd_Helper ProfEd_Helper;
	private ProfEd_Question currentQuestion;
	private List<ProfEd_Question> list;
	private int qid = 0;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.reviewer_profed);
		customActionBar();
		initLayout();
		...
		ColorPrefUtil.changeTextColorOfSingleView(this, question_profed, colorTextColor, colorTextColor);
	...
	private void Review()
	{
		...
		list = ProfEd_Helper.getAllOfTheQuestions();
	...
	{
		question_profed.setText(currentQuestion.getQuestion());
	...
	private void customActionBar()
	{
		...
		Subtitle.setText("PROFESSIONAL EDUCATION");
	...
	private void initLayout()
	{
		...
		question = (TextView) findViewById(R.id.question_profed);
		...
		question_profed = (TextView) findViewById(R.id.question_profed);
	...
	{
		LayoutInflater inflater = LayoutInflater.from(ProfEd_Activity.this);  
		...
		ColorPrefUtil.changeBackgroundDrawableOfChildViews(ProfEd_Activity.this, holder, colorBox);
		ColorPrefUtil.changeTextColorOfChildViews(ProfEd_Activity.this, pDialogLinear, colorTextColor, colorTextColor);
		ColorPrefUtil.changeBackgroundDrawableOfSingleView(ProfEd_Activity.this, pEnd, colorBox);
		ColorPrefUtil.changeTextColorOfSingleView(ProfEd_Activity.this, pEnd, colorTextColor, colorTextColor);
		...
		pEnd.setOnClickListener(new View.OnClickListener(){
				...
				public void onClick(View p1)
				{
					startActivity(new Intent(ProfEd_Activity.this, Home.class));
					finish();
				}
		});
		final BottomSheetDialog dialog =new BottomSheetDialog(ProfEd_Activity.this,R.style.SheetDialog);
	...
	public void dialog_next() {
		...
		ColorPrefUtil.changeBackgroundDrawableOfSingleView(ProfEd_Activity.this, nHome, colorBox);
		ColorPrefUtil.changeBackgroundDrawableOfSingleView(ProfEd_Activity.this, nNext, colorBox);
	
		ColorPrefUtil.changeTextColorOfSingleView(ProfEd_Activity.this, nNext, colorTextColor, colorTextColor);
	...
	public void dialog_question(String questionstr){
		...
		ColorPrefUtil.changeBackgroundDrawableOfSingleView(ProfEd_Activity.this, question_bg, colorBox);
		ColorPrefUtil.changeTextColorOfSingleView(ProfEd_Activity.this, question, colorTextColor, colorTextColor);


		AlertDialog.Builder ab = new AlertDialog.Builder(ProfEd_Activity.this);
