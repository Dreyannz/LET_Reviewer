...
public class ProfEd_Helper extends SQLiteOpenHelper
{
	private Context context;
    private static final String DB_NAME = "LET_REVIEWER_P.db";
    private static final int DB_VERSION = 1;
    private static final String TABLE_NAME = "ProfEdQuestions";
	...
	public void addAllQuestions(ArrayList<ProfEd_Question> allQuestions)
	{
		SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        try {
            ContentValues values = new ContentValues();
            for (ProfEd_Question question : allQuestions) {
    ...
    List<ProfEd_Question> getAllOfTheQuestions() {

        List<ProfEd_Question> questionsList = new ArrayList<>();
        SQLiteDatabase db = this.getWritableDatabase();
        db.beginTransaction();
        ...
        while (cursor.moveToNext()) {
            ProfEd_Question question = new ProfEd_Question();
